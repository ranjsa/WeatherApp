...
public class MainActivity extends AppCompatActivity {
    ...
    LocationManager mLocationManager; // Location Manager will start or stop Location Updates
    LocationListener mLocationListner; // Location Listener will be notified when the location is actully changed
    ...
    private void getWeatherForCurrentLocation() {
        ...
        mLocationListner = new LocationListener() {
            ...
            public void onProviderDisabled(String provider) {
                Log.d("WeatherApp", "onProviderDisabled callback recived");
            }
        };
